...
<input type="button" class="button" name="userpass" value="중복체크" onClick="isDup()">
</div>
<div id="pass">비밀번호</div>
<div><input type="password" id="passBox" class="box" name="userPass" placeholder="비밀번호를 입력해주세요."></div>
<div><input type="password" id="passBox2"class="box" name="userPass2" placeholder="비밀번호를 다시 입력해주세요."></div>

<div id="Phone">전화번호</div>
<div><input type="text" class="box" id="userPhone" name="userPhone" placeholder="-빼고 입력해주세요."></div>

<div class="name">
<div><input type="text" id=name" class="box" name="userName" placeholder="이름"></div>
</div>


<div id="mail">이메일</div>
<div><input type="email" class="box" id="userMail" name="userMail" placeholder="이메일">&nbsp;@
<select class="mailbox" name="mailAdd">
<option >직접입력</option>
...
<input type="button" class="button" name="userpass" value="가입하기" onClick="joinInfo()"></div></div>
